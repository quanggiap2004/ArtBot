---
title: 'Advanced: How to Manually Install & Activate OptiSigns Remote Agent on Linux
  or Raspberry Pi'
article_id: 360057146573
...
updated_at: '2025-09-02T20:02:58Z'
---
...
```
<path>/optisigns-remote-agent [arg]install : to install remote agentremove : to remove/uninstall remote agentstart or restart : to start remote agent servicestop : to stop remote agent serviceversion or -V : to print remote agent versionhelp : to print this instructionsrun : to run the remote agent in console or terminal or service
```
