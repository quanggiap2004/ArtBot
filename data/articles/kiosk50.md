...
1. Click the **Content Type** drop down list and select **Playlist** & select the playlist you want to use. If you haven't created a playlist yet, you can use the Simple Playlist that was automatically created with your account.
