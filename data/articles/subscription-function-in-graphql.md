...
```
subscription subscribe($_id:String,$type:OBJECT_TYPES){  subscribe(_id:$_id,type:$type){    _id,    mutation,    teamId    type  }}
```
...
```
mutation updateDevice($_id: String!,$payload: UpdateDeviceInput!, $teamId: String){  updateDevice(_id:$_id,payload:$payload,teamId:$teamId){     _id,     deviceName,     UUID,     pairingCode,     currentType,     currentAssetId,     currentPlaylistId,     path,     localAppVersion  }}
```

**Variables**

```
{"_id": "",  "payload": {"deviceName": "",    "currentType": "",    "currentAssetId": “”,    "currentPlaylistId": "",    "orientation": "LANDSCAPE"  } }
```
