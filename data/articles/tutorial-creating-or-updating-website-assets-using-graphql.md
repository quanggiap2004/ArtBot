...
```
mutation saveAsset ($payload: AssetInput!, $teamId: String){saveAsset (payload:$payload,teamId:$teamId){  _id  originalFileName  webLink  webType  fileType  }}
```

**Variables:**

```
{  "payload": {    "originalFileName": "",    "webLink": "",    "webType": "",    "fileType": ""  }}
```
...
```
{  "payload": {    "_id": "",    "originalFileName": "",    "webLink": "",    "webType": "",    "fileType": ""  }}
```
